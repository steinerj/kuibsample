...
export class AuthenticationService {
    ...
    constructor (@Inject('AuthenticationConfig') protected config: any, private router: Router,
        private location: Location, private sessionStorageService: SessionStorageService, private injector: Injector) {
